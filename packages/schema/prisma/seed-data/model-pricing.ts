...
export const MODEL_PRICING_DATA = [
  ...
  // ==========================================
  {
    ...
    reasoningTokenCost: new Prisma.Decimal('12'),
    creditsPerMillionInputTokens: BigInt(20000),
    creditsPerMillionOutputTokens: BigInt(80000),
    creditsPerMillionReasoningTokens: BigInt(120000),
    maxTokens: 200000,
  ...
  },
  {
    ...
    reasoningTokenCost: new Prisma.Decimal('120'),
    creditsPerMillionInputTokens: BigInt(200000),
    creditsPerMillionOutputTokens: BigInt(800000),
    creditsPerMillionReasoningTokens: BigInt(1200000),
    maxTokens: 200000,
    maxOutputTokens: 100000,
    supportsStreaming: true,
    supportsFunctions: false,
  ...
  },
  {
    ...
    reasoningTokenCost: new Prisma.Decimal('60'),
    creditsPerMillionInputTokens: BigInt(100000),
    creditsPerMillionOutputTokens: BigInt(400000),
    creditsPerMillionReasoningTokens: BigInt(600000),
    maxTokens: 200000,
    maxOutputTokens: 100000,
    supportsStreaming: true,
    supportsFunctions: false,
  ...
  },
  {
    ...
    reasoningTokenCost: new Prisma.Decimal('30'),
    creditsPerMillionInputTokens: BigInt(50000),
    creditsPerMillionOutputTokens: BigInt(200000),
    creditsPerMillionReasoningTokens: BigInt(300000),
    maxTokens: 200000,
    maxOutputTokens: 100000,
    supportsStreaming: true,
    supportsFunctions: false,
