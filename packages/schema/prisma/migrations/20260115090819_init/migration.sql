...
CREATE TABLE "billing"."ModelPricingTier" (
    ...
    "inputTokenCost" DECIMAL(18,10) NOT NULL,
    "outputTokenCost" DECIMAL(18,10) NOT NULL,
    "reasoningTokenCost" DECIMAL(18,10) NOT NULL DEFAULT 0,
    "creditsPerMillionInputTokens" BIGINT NOT NULL,
    "creditsPerMillionOutputTokens" BIGINT NOT NULL,
    "creditsPerMillionReasoningTokens" BIGINT NOT NULL DEFAULT 0,
    "maxTokens" INTEGER,
